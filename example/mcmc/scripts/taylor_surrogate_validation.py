...
# cell "Configuration (mirrors the Fisher notebook)". Must stay in lockstep
# with scripts/build_taylor_templates_lcdm.py (the META guard enforces the
# grid part; the packed-vector tripwire below enforces the fiducials).
# ---------------------------------------------------------------------------
